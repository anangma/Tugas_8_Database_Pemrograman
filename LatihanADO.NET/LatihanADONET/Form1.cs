...
namespace LatihanADONET
{
    public partial class Form1 : Form
    {
        ...
        private SQLiteConnection GetOpenConnection()
        {
            ...
            try
            {
                string dbName = @"C:\Users\LCNRC\Downloads\pertemuan8\pertemuan8\Module Praktikum 08 (ADO.NET)\Module Praktikum 08 (ADO.NET)\LatihanADO.NET\Database\DbPerpustakaan.db";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("Apakah data mahasiswa ingin dihapus? !", "Informasi",
               MessageBoxButtons.YesNo) == DialogResult.Yes )
            {
                ...
                MessageBox.Show("Data mahasiswa berhasil di Delete !", "Informasi",
               MessageBoxButtons.OK,
                MessageBoxIcon.Information);
                ...
                MessageBox.Show("Data mahasiswa gagal di Delete !!!", "Informasi",
               MessageBoxButtons.OK,
                MessageBoxIcon.Exclamation);
